...
let useUserStore = defineStore('User', {
    ...
    actions: {
        ...
        async userLogin(data: loginFormData) {
            //登录请求
            let result: loginResponseData = (await reqLogin(data) as any).data
            //登录请求:成功200->token 
            ...
            if (result.code == 200) {
                ...
                this.username = ((result as any).username)
                //本地存储持久化存储一份
        ...
        async userInfo() {
            ...
            let result: userInfoReponseData =( await reqUserInfo() as any).data   ;
            console.log(result);
